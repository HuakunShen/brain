...
We want to make an exact copy of an object (copy every property). The most intuitive method is to make a new object with
...
[code](https://refactoring.guru/design-patterns/prototype/java/example)
